    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Se déconnecter des autres appareils') }}
            </x-button>
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Veuillez entrer votre mot de passe pour confirmer que vous souhaitez vous déconnecter de toutes les autres sessions de votre navigateur sur tous vos appareils.') }}
