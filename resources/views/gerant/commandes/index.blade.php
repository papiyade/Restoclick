...
<body>
    ...
    @section('title', 'Page des Commandes')
    @section('content')
    ...
    if (confirm(`Êtes-vous sûr de vouloir encaisser la commande ${id}?`)) {
        ...
        .then(data => {
            if (data.status === 'success') {
                ...
                encaisserBtn.outerHTML = `<span class="badge bg-success" id="status-badge-${id}">Encaissée</span>`;
...
$(document).ready(function() {
    $('.view-order-details').on('click', function() {
        ...
        $('#order-details-content').html('<div class="spinner-border text-primary" role="status"><span class="sr-only">Chargement...</span></div>');
        $.ajax({
