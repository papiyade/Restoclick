...
<body>
    ...
    @section('content')
        ...
        <div class="d-flex justify-content-between mb-4 flex-wrap">
            ...
            <form id="filter-form" class="d-flex mb-4">
                <input type="text" id="search" name="search" class="form-control me-2" placeholder="Rechercher un client...">
                <select id="status" name="status" class="form-select me-2">
                    <option value="">Tous les statuts</option>
                    <option value="Confirmée">Confirmée</option>
                    <option value="En Attente">En Attente</option>
                </select>
                <button type="button" class="btn btn-primary" id="filter-button">Filtrer</button>
            </form>
                                ...
                                <div class="table-responsive active-projects style-1 ItemsCheckboxSec shorting">
                                    ...
                                    <table class="table table-sm mb-0 table-striped student-tbl">
                                        ...
                                        <tbody id="customers">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    <td class="py-2">
                                                        <div class="form-check custom-checkbox mx-2">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="customCheckBox{{ $commande->id }}">
                                                            <label class="form-check-label"
                                                                for="customCheckBox{{ $commande->id }}"></label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="py-2">
                                                        <span style="margin-left: 25px;"
                                                            class="badge rounded-pill {{ $commande->statut === 'En Attente' ? 'badge-warning' : ($commande->statut === 'Confirmée' ? 'badge-success' : 'badge-secondary') }}">
                                                            {{ $commande->statut }}
                                                        </span>
                                                    </td>
                                                    <td class="py-2"> Le {{ $commande->created_at->format('d/m/Y H:i') }}
                                                    </td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center">Aucune Commande pour le moment
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
