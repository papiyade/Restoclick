            ...
            <div class="card-body">
                ...
                @foreach($categories as $category)
                    ...
                    @if($menu->plats->where('category_id', $category->id)->count() > 0)
                        <h1 class="text-blue">{{ $category->name }}</h1>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <a href="{{ route('admin.menus.edit', $menu) }}" style="border: none;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <form action="{{ route('admin.menus.destroy', $menu) }}" method="POST" class="d-inline">
                        ...
                        <button type="submit" style="border: none;"  onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce menu ?')"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
