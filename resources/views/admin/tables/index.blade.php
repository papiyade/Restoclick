            ...
            <tbody>
                @foreach($tables as $table)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.tables.edit', $table) }}" class="btn btn-info">
...
@section('content')
    <h1>Liste des Tables</h1>
    <a href="{{ route('admin.tables.create') }}" class="btn btn-success">Ajouter</a>
            ...
            <tbody>
                @foreach($tables as $table)
                    <tr>
                        ...
                        <td>
                            @if($table->qr_code)
                                <img src="{{ asset($table->qr_code) }}" alt="QR Code" width="100">
                            @endif
                        </td>
                        <td>
                            <span class="badge badge-{{ $table->statut == 'disponible' ? 'success' : 'warning' }}">
