            ...
            <div class="card">
                <div class="card-body d-flex justify-content-between">
                    <div class="card-menu">
                        ...
                        <h2 class="mb-0"> {{$reservationCount}} </h2>
                    </div>
                    <div class="icon-box icon-box-lg bg-primary-light">
                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>{{ $user->name }}</td>
                                            <td>{{ $user->email }}</td>
                                            <td>{{ optional($user->restaurant)->name }}</td>
                                            <!-- Affichage du nom du restaurant associé à l'utilisateur -->
                                            <td>{{ $user->role }}</td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('superadmin.users.edit', ['id' => $user->id]) }}">Modifier</a>
                                                        <form method="POST"
