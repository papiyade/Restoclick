...
<head>
    ...
    flex-grow: 1;
    height: 0.1px;
    background-color: #977644; /* Couleur de la ligne */
        ...
        <div id="page" class="">
            ...
            <header id="header_main" class="header header-fixed">
                ...
                <div class="mobile-nav-wrap">
                    ...
                    <div class="inner-mobile-nav">
                        <div class="relative">
                            <a href="index.html" rel="home" class="main-logo">
                                <img id="mobile-logo_header" alt="" src="{{asset('front/assets/images/logo/logo.png')}}" data-retina="front/assets/images/logo/logo@2x.png">
                            </a>
            ...
            <div class="banner-page inner-page menu-page">
                <div class="content">
                    ...
                    <p>Explore our menu with a wide range of Asian to European dishes, dishes to suit all <br> your tastes or events</p>
                </div>
            </div>
            <!-- /banner-page -->
            ...
            <div class="page-menu2-wrap relative snare-half">
                ...
                <img class="item-2" src="front/assets/images/item-background/item-1.png" alt="">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center">
                                <img class=" wow fadeInUp" src="front/assets/images/item-background/menu-1.png" alt="">
                ...
                <div class="widget-tabs style-1">
                                            ...
                                            <div class="wg-menu-item">
                                                @if ($lastMenu)
                                                    @foreach ($lastMenu->plats as $plat)
                                                        <div class="col-lg-6 menu-item filter-{{ $plat->category_id }} menu-grid-item">
                    ...
                    <div class="button-bot">
                        <a class="button-two-line w-full" href="{{ route('client.book-table', ['id' => $restaurant->id]) }}">BOOK A TABLE TODAY</a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="logo-footer" id="logo-footer">
                                <a href="index.html">
                                    <img id="logo_footer" alt="" src="front/assets/images/logo/logo-ft.png" data-retina="assets/images/logo/logo-ft@2x.png">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4">
